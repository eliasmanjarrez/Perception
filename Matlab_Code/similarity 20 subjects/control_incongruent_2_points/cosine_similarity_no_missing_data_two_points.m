...
ylabel('tau (ms)');
zlabel('mu (ms)');
title('Sets of Two Points for 20 Subjects in 3D Space (Incongruent)');
...
title('Similarity Index Matrix for 20 Subjects (incongruent)');
...
title('Histogram of similarity index for 20 subjects (incongruent)');
xlabel('Similarity index');
ylabel('Counts');

save similarities_control_incongruent.txt similarities -ascii
save non_zero_similarities_control_incongruent.txt non_zero_similarities -ascii
